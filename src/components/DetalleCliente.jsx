...
export default function DetalleCliente() {
  return (
    <div className="max-w-2xl bg-white rounded-lg shadow-lg border-t-4 border-[#001d3d] p-8">
      ...
      <form className="space-y-6">
        ...
        <div className="pt-4">
          <Link 
            href="/crm/customer" 
            className="inline-flex items-center gap-2 bg-[#001d3d] text-white px-8 py-3 rounded-md font-bold hover:bg-blue-900 transition-all active:scale-95"
          >
            <ArrowLeft size={18} />
            Volver
          </Link>
