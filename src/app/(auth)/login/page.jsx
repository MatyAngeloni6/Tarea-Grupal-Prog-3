...
function page() {
  return (
    <main className="flex min-h-screen max-h-screen items-center justify-center bg-gray-800 ">
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                  ...
                  <div className="flex items-center justify-between">
                      ...
                      <a href="/forgot-password" className="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Olvido la contrasena?</a>
                  </div>
                  <button type="submit" className="hover:scale-105 border-1 w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 cursor-pointer">Iniciar sesión</button>
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                      No tiene cuenta creada? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Registrarse</a>
                  </p>
              </form>
          </div>
      </div>
